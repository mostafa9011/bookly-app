...
class HomeRepoImplemetation implements HomeRepo {
  ...
  @override
  Future<Either<Failures, BookModel>> getBestSellerBooks() async {
    try {
      var data =
  ...
  Future<Either<Failures, BookModel>> getPopularBook(
    ...
    try {
      var data = await apiManager.get(
          endPoint: EndPoint.volumes, queryParameters: queryParameters);
      BookModel model = BookModel.fromJson(data);
      return right(model);
    } on DioException catch (e) {
      return left(ServerFailure.fromDioException(e));
  ...
  @override
  Future<Either<Failures, BookModel>> getSimailarBooks(
